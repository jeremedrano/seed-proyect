...
class UserCreateRequest(BaseModel):
    ...
    model_config = {
        "json_schema_extra": {
            "examples": [{"email": "user@example.com", "name": "John Doe", "age": 30}]
        }
    }
...
class UserResponse(BaseModel):
    ...
    model_config = {
        ...
        "json_schema_extra": {
            "examples": [{"id": 1, "email": "user@example.com", "name": "John Doe", "age": 30}]
        },
    }
...
class UserUpdateRequest(BaseModel):
    ...
    model_config = {"json_schema_extra": {"examples": [{"name": "Jane Doe", "age": 31}]}}
